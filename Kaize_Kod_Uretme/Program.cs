...
//        }
//    }
//    static List<string> GenerateCodes(int numCodes)
//    {
//        List<string> generatedCodes = new List<string>();
//        Random random = new Random();

//        // 2 ile 22 arasındaki sayıların kümesini oluştur
//        List<int> indices = Enumerable.Range(2, 8).ToList();

//        // 7'li permütasyonu al ve numCodes sayısına kadar olan olasılıkları elde et
//        List<List<int>> permutations = GetPermutations(indices, 7);
//        permutations = permutations.Take(numCodes).ToList();

//        foreach (List<int> permutation in permutations)
//        {
//            string code = "";
//            int start = random.Next(1, 23); // Kodun başlangıç indexi için random bir değer atıyoruz
//            int prevIndex = start;
